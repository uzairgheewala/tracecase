.PHONY: test validate sample milestone-b-fixtures milestone-c-fixtures milestone-d-fixtures milestone-e-fixtures clean
...
milestone-e-fixtures:
	PYTHONPATH=$(PYTHONPATH) python scripts/generate_milestone_e_fixtures.py
